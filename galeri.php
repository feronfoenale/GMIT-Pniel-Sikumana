...
//query
$foto = "SELECT * FROM tbl_galeri LIMIT $start, $perpage";
$result1 = mysqli_query($conn, $foto);


//pagination;
$result= mysqli_query($conn, "SELECT * FROM tbl_galeri");
                    ...
                    <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
                            <div class="portfolio-content h-100">
                                <img src="./Admin/upload/galeri<?= $row['foto']; ?>" class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4><?=$row['nama_foto']?></h4>
                                    <a href="./Admin/upload/galeri<?= $row['foto']; ?>"
