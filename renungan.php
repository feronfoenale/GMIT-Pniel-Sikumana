...
//query
$renungan = "SELECT * FROM tbl_renungan LIMIT $start, $perpage";
$ren = mysqli_query($conn, $renungan);

//pagination;
$result= mysqli_query($conn, "SELECT * FROM tbl_renungan");
        ...
        <section id="blog" class="blog">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4 posts-list">
                    <?php while($row = mysqli_fetch_assoc($ren)): ?>
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100">

                            <div class="post-img position-relative overflow-hidden">
                                <img src="assets/img/warta/rn.png" class="img-fluid" alt="">
                                <span class="post-date"><?= date('F j', strtotime($row["tgl_r"]));?></span>
                            </div>
                            ...
                            <div class="post-content d-flex flex-column">
                                ...
                                <a href="<?=$row['deskripsi']?>" class="readmore stretched-link"><span>Baca
