...
<body>
    ...
    <div class="breadcrumbs d-flex align-items-center"
        ...
        <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">
            ...
            <h2>Sejarah Gmit Pniel Sikumana</h2>
            <ol>
    ...
    <br>
    <main id="main">
        <h1 style="text-align: center; color: black;">Sejarah Gmit Pniel Sikumana</h1>
        <br>
        <object data="assets/file/caridokumen.com_sejarah-gereja-.pdf" width="100%" height="700"></object>
